...
if %MsBuild%=="" (
    ...
    copy "C:\src\github\phuocle\Dynamics-Crm-DevKit\source\PL.DynamicsCrm.DevKit.Cli\Release\PL.DynamicsCrm.DevKit.Cli.exe" "C:\src\azure\abiz\git\ABIZ_VIAGS\src\packages\PL.DynamicsCrm.DevKit.Cli.1.5.0\tools\PL.DynamicsCrm.DevKit.Cli.exe" /y
)
rem exit