...
declare namespace $ProjectJsName$ {
    namespace WebApi {
        class AlternateKey {
            /**
...
declare namespace WebApiClient {
     ...
     * @param request the $ProjectJsName$.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: $ProjectJsName$.WebApi.RetrieveRequest): RetrieveResponse;
    /**
     * Retrieves records from CRM (async = false).
     * @param request the $ProjectJsName$.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: $ProjectJsName$.WebApi.RetrieveRequest): void;
    /**
     * Creates a given record in CRM (async = true).
     * @param request The $ProjectJsName$.WebApi.CreateRequest object.
     */
    function Create(request: $ProjectJsName$.WebApi.CreateRequest): CreateResponse;
    /**
     * Creates a given record in CRM (async = false).
     * @param request The $ProjectJsName$.WebApi.CreateRequest object.
     */
    function Create(request: $ProjectJsName$.WebApi.CreateRequest): void;
    /**
     * Updates a given record in CRM (async = true).
     * @param request the $ProjectJsName$.WebApi.UpdateRequest object.
     */
    function Update(request: $ProjectJsName$.WebApi.UpdateRequest): UpdateResponse;
    /**
     * Updates a given record in CRM (async = false).
     * @param request the $ProjectJsName$.WebApi.UpdateRequest object.
     */
    function Update(request: $ProjectJsName$.WebApi.UpdateRequest): void;
    /**
     * Deletes a given record in CRM (async = true).
     * @param request the $ProjectJsName$.WebApi.DeleteRequest object.
     */
    function Delete(request: $ProjectJsName$.WebApi.DeleteRequest): DeleteResponse;
    /**
     * Deletes a given record in CRM (async = false).
     * @param request the $ProjectJsName$.WebApi.DeleteRequest object.
     */
    function Delete(request: $ProjectJsName$.WebApi.DeleteRequest): void;
    /**
     * Associates given records in CRM (async = true).
     * @param request the $ProjectJsName$.WebApi.AssociateRequest object.
     */
    function Associate(request: $ProjectJsName$.WebApi.AssociateRequest): AssociateResponse;
    /**
     * Associates given records in CRM (async = false).
     * @param request the $ProjectJsName$.WebApi.AssociateRequest object.
     */
    function Associate(request: $ProjectJsName$.WebApi.AssociateRequest): void;
    /**
     * Disassociates given records in CRM (async = true).
     * @param request the $ProjectJsName$.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: $ProjectJsName$.WebApi.DisassociateRequest): DisassociateResponse;
    /**
     * Disassociates given records in CRM (async = false).
     * @param request the $ProjectJsName$.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: $ProjectJsName$.WebApi.DisassociateRequest): void;
    /**
