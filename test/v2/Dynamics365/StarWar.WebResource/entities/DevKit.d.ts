...
declare namespace WebApiClient {
     ...
     * @param request the WebResource.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: WebResource.WebApi.RetrieveRequest): RetrieveResponse;
    /**
     * Retrieves records from CRM (async = false).
     * @param request the WebResource.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: WebResource.WebApi.RetrieveRequest): void;
    /**
     * Creates a given record in CRM (async = true).
     * @param request The WebResource.WebApi.CreateRequest object.
     */
    function Create(request: WebResource.WebApi.CreateRequest): CreateResponse;
    /**
     * Creates a given record in CRM (async = false).
     * @param request The WebResource.WebApi.CreateRequest object.
     */
    function Create(request: WebResource.WebApi.CreateRequest): void;
    /**
     * Updates a given record in CRM (async = true).
     * @param request the WebResource.WebApi.UpdateRequest object.
     */
    function Update(request: WebResource.WebApi.UpdateRequest): UpdateResponse;
    /**
     * Updates a given record in CRM (async = false).
     * @param request the WebResource.WebApi.UpdateRequest object.
     */
    function Update(request: WebResource.WebApi.UpdateRequest): void;
    /**
     * Deletes a given record in CRM (async = true).
     * @param request the WebResource.WebApi.DeleteRequest object.
     */
    function Delete(request: WebResource.WebApi.DeleteRequest): DeleteResponse;
    /**
     * Deletes a given record in CRM (async = false).
     * @param request the WebResource.WebApi.DeleteRequest object.
     */
    function Delete(request: WebResource.WebApi.DeleteRequest): void;
    /**
     * Associates given records in CRM (async = true).
     * @param request the WebResource.WebApi.AssociateRequest object.
     */
    function Associate(request: WebResource.WebApi.AssociateRequest): AssociateResponse;
    /**
     * Associates given records in CRM (async = false).
     * @param request the WebResource.WebApi.AssociateRequest object.
     */
    function Associate(request: WebResource.WebApi.AssociateRequest): void;
    /**
     * Disassociates given records in CRM (async = true).
     * @param request the WebResource.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: WebResource.WebApi.DisassociateRequest): DisassociateResponse;
    /**
     * Disassociates given records in CRM (async = false).
     * @param request the WebResource.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: WebResource.WebApi.DisassociateRequest): void;
    /**
