...
if %MsBuild%=="" (
	...
	call %MsBuild% /nologo /noautorsp /verbosity:quiet /p:DefineConstants="DEBUG" /p:Configuration=Debug Facebook.Vietnam.Hcm.Workflow.Account.2013.452.csproj
)
...
"%PLDynamicsCrmDevKitCli%\tools\PL.DynamicsCrm.DevKit.Cli.exe" /conn:%CrmConnection% /json:"..\PL.DynamicsCrm.DevKit.Cli.json" /type:"workflows" /profile:"DEBUG"
exit