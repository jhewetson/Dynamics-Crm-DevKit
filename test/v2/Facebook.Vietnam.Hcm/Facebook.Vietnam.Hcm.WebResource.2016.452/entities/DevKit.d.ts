...
declare namespace WebApiClient {
     ...
     * @param request the Hcm.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: Hcm.WebApi.RetrieveRequest): RetrieveResponse;
    /**
     * Retrieves records from CRM (async = false).
     * @param request the Hcm.WebApi.RetrieveRequest object.
     */
    function Retrieve(request: Hcm.WebApi.RetrieveRequest): void;
    /**
     * Creates a given record in CRM (async = true).
     * @param request The Hcm.WebApi.CreateRequest object.
     */
    function Create(request: Hcm.WebApi.CreateRequest): CreateResponse;
    /**
     * Creates a given record in CRM (async = false).
     * @param request The Hcm.WebApi.CreateRequest object.
     */
    function Create(request: Hcm.WebApi.CreateRequest): void;
    /**
     * Updates a given record in CRM (async = true).
     * @param request the Hcm.WebApi.UpdateRequest object.
     */
    function Update(request: Hcm.WebApi.UpdateRequest): UpdateResponse;
    /**
     * Updates a given record in CRM (async = false).
     * @param request the Hcm.WebApi.UpdateRequest object.
     */
    function Update(request: Hcm.WebApi.UpdateRequest): void;
    /**
     * Deletes a given record in CRM (async = true).
     * @param request the Hcm.WebApi.DeleteRequest object.
     */
    function Delete(request: Hcm.WebApi.DeleteRequest): DeleteResponse;
    /**
     * Deletes a given record in CRM (async = false).
     * @param request the Hcm.WebApi.DeleteRequest object.
     */
    function Delete(request: Hcm.WebApi.DeleteRequest): void;
    /**
     * Associates given records in CRM (async = true).
     * @param request the Hcm.WebApi.AssociateRequest object.
     */
    function Associate(request: Hcm.WebApi.AssociateRequest): AssociateResponse;
    /**
     * Associates given records in CRM (async = false).
     * @param request the Hcm.WebApi.AssociateRequest object.
     */
    function Associate(request: Hcm.WebApi.AssociateRequest): void;
    /**
     * Disassociates given records in CRM (async = true).
     * @param request the Hcm.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: Hcm.WebApi.DisassociateRequest): DisassociateResponse;
    /**
     * Disassociates given records in CRM (async = false).
     * @param request the Hcm.WebApi.DisassociateRequest object.
     */
    function Disassociate(request: Hcm.WebApi.DisassociateRequest): void;
    /**
