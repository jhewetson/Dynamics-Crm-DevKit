...
declare namespace Hsbc {
	class BookableResourceBookingExchangeSyncIdMappingApi {
		/**
		* PL.DynamicsCrm.DevKit BookableResourceBookingExchangeSyncIdMappingApi
		...
		*/
		...
		"@odata.etag": string;
		BookableResourceBookingExchangeSyncIdMappingId: DevKit.WebApi.GuidValue;
		...
		SyncStatus: DevKit.WebApi.OptionSetValue;
		SyncVersionNumber: DevKit.WebApi.BigIntValue;
...
declare namespace OptionSet {
	namespace BookableResourceBookingExchangeSyncIdMapping {
		enum SyncStatus {
			/** 0 */
			Completed,
			/** 1 */
