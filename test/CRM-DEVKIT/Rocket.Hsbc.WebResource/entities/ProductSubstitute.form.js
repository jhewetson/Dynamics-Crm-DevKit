...
(function (Hsbc) {
	...
	Hsbc.FormProductSubstitute = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormProductSubstituteQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
