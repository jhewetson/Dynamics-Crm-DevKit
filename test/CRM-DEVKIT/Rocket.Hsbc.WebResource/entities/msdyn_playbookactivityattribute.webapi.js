...
(function (Hsbc) {
	'use strict';
	Hsbc.msdyn_playbookactivityattributeApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_playbookactivityattribute) {
			var a = msdyn_playbookactivityattribute[field].a;
			var b = msdyn_playbookactivityattribute[field].b;
			var c = msdyn_playbookactivityattribute[field].c;
			var d = msdyn_playbookactivityattribute[field].d;
			var g = msdyn_playbookactivityattribute[field].g;
			var r = msdyn_playbookactivityattribute[field].r;
			msdyn_playbookactivityattribute[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_playbookactivityattribute.OptionSet = optionSet;
		msdyn_playbookactivityattribute.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_playbookactivityattribute.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
