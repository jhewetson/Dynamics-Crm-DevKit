...
(function (Hsbc) {
	...
	Hsbc.CompetitorApi = function (e) {
		...
		var competitor = {
			...
			ReferenceInfoUrl: { a: 'referenceinfourl' },
			ReportedRevenue: { a: 'reportedrevenue' },
			ReportedRevenue_Base: { a: 'reportedrevenue_base', r: true },
			ReportingQuarter: { a: 'reportingquarter' },
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in competitor) {
			var a = competitor[field].a;
			var b = competitor[field].b;
			var c = competitor[field].c;
			var d = competitor[field].d;
			var g = competitor[field].g;
			var r = competitor[field].r;
			competitor[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		competitor.Entity = u;
		competitor.EntityName = 'competitor';
		competitor.EntityCollectionName = 'competitors';
		competitor['@odata.etag'] = e['@odata.etag'];
		var optionSet = {
			RollupState: {
				NotCalculated: 0,
				Calculated: 1,
		...
		competitor.OptionSet = optionSet;
		competitor.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		competitor.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
