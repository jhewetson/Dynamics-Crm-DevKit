...
declare namespace Hsbc {
	namespace Formmsfp_surveyInformation {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsfp_surveyInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form msfp_surveyInformation
		...
		*/
		...
		/** The Body section of form msfp_surveyInformation */
		Body: Hsbc.Formmsfp_surveyInformation.Body;
	}
	class msfp_surveyApi {
		/**
		* PL.DynamicsCrm.DevKit msfp_surveyApi
