...
(function (Hsbc) {
	'use strict';
	Hsbc.DynamicPropertyAssociationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in dynamicpropertyassociation) {
			var a = dynamicpropertyassociation[field].a;
			var b = dynamicpropertyassociation[field].b;
			var c = dynamicpropertyassociation[field].c;
			var d = dynamicpropertyassociation[field].d;
			var g = dynamicpropertyassociation[field].g;
			var r = dynamicpropertyassociation[field].r;
			dynamicpropertyassociation[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		dynamicpropertyassociation.OptionSet = optionSet;
		dynamicpropertyassociation.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		dynamicpropertyassociation.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
