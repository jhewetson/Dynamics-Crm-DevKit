...
(function (Hsbc) {
	...
	Hsbc.FormCategory = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormCategoryMainInteractive = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Hsbc.FormCategoryQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
