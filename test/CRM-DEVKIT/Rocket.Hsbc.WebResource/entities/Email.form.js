...
(function (Hsbc) {
	...
	Hsbc.FormEmail = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormEmailforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
