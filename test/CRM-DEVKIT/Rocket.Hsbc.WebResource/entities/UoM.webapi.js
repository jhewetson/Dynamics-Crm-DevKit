...
(function (Hsbc) {
	...
	Hsbc.UoMApi = function (e) {
		...
		var uom = {
			BaseUoM: { b: 'baseuom', a: '_baseuom_value', c: 'uoms', d: 'uom' },
			...
			IsScheduleBaseUoM: { a: 'isschedulebaseuom', r: true },
		...
		for (var field in uom) {
			...
			var g = uom[field].g;
			var r = uom[field].r;
			uom[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		uom.Entity = u;
		uom.EntityName = 'uom';
		uom.EntityCollectionName = 'uoms';
		uom['@odata.etag'] = e['@odata.etag'];
		var optionSet = {
			RollupState: {
				NotCalculated: 0,
				Calculated: 1,
		...
		uom.OptionSet = optionSet;
		uom.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		uom.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
