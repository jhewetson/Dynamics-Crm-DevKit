...
declare namespace Hsbc {
	namespace Formmsdyn_forecastrecurrenceInformation {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsdyn_forecastrecurrenceInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form msdyn_forecastrecurrenceInformation
		...
		*/
		...
		/** The Body section of form msdyn_forecastrecurrenceInformation */
		Body: Hsbc.Formmsdyn_forecastrecurrenceInformation.Body;
	}
