...
(function (Hsbc) {
	...
	Hsbc.FormKnowledgeArticleIncident = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormKnowledgeArticleIncidentforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
