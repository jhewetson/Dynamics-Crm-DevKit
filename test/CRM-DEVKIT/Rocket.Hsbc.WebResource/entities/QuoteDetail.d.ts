...
declare namespace Hsbc {
	namespace FormQuoteDetailInformation {
		interface tab_general_Sections {
			quotedetailinformation: DevKit.Form.Controls.ControlSection;
	...
	class FormQuoteDetailInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form QuoteDetailInformation
		...
		*/
		...
		/** The Body section of form QuoteDetailInformation */
		Body: Hsbc.FormQuoteDetailInformation.Body;
	}
	...
	class FormQuoteDetail extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form QuoteDetail
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: Hsbc.FormQuoteDetail.Body;
	}
...
//{'JsForm':['Information','QuoteDetail'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}