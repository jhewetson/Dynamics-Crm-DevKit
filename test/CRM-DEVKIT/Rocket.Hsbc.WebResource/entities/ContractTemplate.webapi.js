...
(function (Hsbc) {
	'use strict';
	Hsbc.ContractTemplateApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in contracttemplate) {
			var a = contracttemplate[field].a;
			var b = contracttemplate[field].b;
			var c = contracttemplate[field].c;
			var d = contracttemplate[field].d;
			var g = contracttemplate[field].g;
			var r = contracttemplate[field].r;
			contracttemplate[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		contracttemplate.OptionSet = optionSet;
		contracttemplate.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		contracttemplate.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
