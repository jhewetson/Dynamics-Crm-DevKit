...
(function (Hsbc) {
	...
	Hsbc.FormInformation = function(executionContext, defaultWebResourceName) {
		...
		var tab = {
			...
			: {
				Section: {
					{1cd67d69-1741-4c0e-a413-7f4a6e91347f}_section_4: {}
				}
			},
			: {
				Section: {
					{1cd67d69-1741-4c0e-a413-7f4a6e91347f}_section_3: {}
				}
			},
			tab_notification: {
				Section: {
		...
		var navigation = {
			...
			navAudit: {},
			navProcessSessions: {},
			nav_msdyn_postconfig_msdyn_postruleconfig: {},
			nav_msdyn_postconfig_wallsavedquery: {}
		};
