...
(function (Hsbc) {
	...
	Hsbc.FormCase = function(executionContext, defaultWebResourceName) {
		...
		var _PhonetoCaseProcess = {
			CustomerId: {},
			ExistingCase: {},
			OwnerId: {},
			PrimaryContactId: {}
		}
		devKit.LoadFields(formContext, _PhonetoCaseProcess, "header_process_");
		process.PhonetoCaseProcess = _PhonetoCaseProcess;
	...
	Hsbc.FormCaseforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Hsbc.FormCaseQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
