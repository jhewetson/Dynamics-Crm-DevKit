...
(function (Hsbc) {
	...
	Hsbc.FormFeedback = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormFeedbackMainIC = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Hsbc.FormFeedbackQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
