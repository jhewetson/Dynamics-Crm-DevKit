...
declare namespace Hsbc {
	...
	class EntitlementEntityAllocationTypeMappingApi {
		...
		*/
		...
		"@odata.etag": string;
		allocationtype: DevKit.WebApi.OptionSetValue;
		...
		EntitlementEntityAllocationTypeMappingId: DevKit.WebApi.GuidValue;
...
declare namespace OptionSet {
	namespace EntitlementEntityAllocationTypeMapping {
		enum allocationtype {
			/** 0 */
			Number_of_cases,
			/** 1 */
