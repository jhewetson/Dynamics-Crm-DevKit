...
declare namespace Hsbc {
	namespace Formmsfp_questionresponseInformation {
		interface Tabs {
		}
		interface Body {
	...
	class Formmsfp_questionresponseInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form msfp_questionresponseInformation
		...
		*/
		...
		/** The Body section of form msfp_questionresponseInformation */
		Body: Hsbc.Formmsfp_questionresponseInformation.Body;
	}
