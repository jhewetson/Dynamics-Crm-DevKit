...
declare namespace Hsbc {
	...
	class msdyn_relationshipinsightsunifiedconfigApi {
		...
		*/
		...
		msdyn_relationshipinsightsunifiedconfigId: DevKit.WebApi.GuidValue;
		msdyn_usenewconfigexperience: DevKit.WebApi.BooleanValue;
		/** The name of the custom entity. */
		new_name: DevKit.WebApi.StringValue;
...
declare namespace OptionSet {
	namespace msdyn_relationshipinsightsunifiedconfig {
		enum statecode {
			/** 0 */
			Active,
			/** 1 */
