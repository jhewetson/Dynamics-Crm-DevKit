...
(function (Hsbc) {
	...
	Hsbc.FormInformation = function(executionContext, defaultWebResourceName) {
		...
		var tab = {
			{70098AD5-4956-11DD-982E-00188B01DCE6}: {
				Section: {
					{70098AD6-4956-11DD-982E-00188B01DCE6}: {},
					description: {},
					{eaf2edb4-7c5e-dd11-940f-00155d8ac303}: {}
				}
			},
			{E1F7A9C9-A0E6-4C8B-ACBD-C6610FBD2343}: {
				Section: {
					{CBF04024-5749-444C-BC51-CFAF839688BF}: {},
					{6FE75F79-0CA8-4DBE-8C7B-6E68C17DE013}: {}
				}
			},
