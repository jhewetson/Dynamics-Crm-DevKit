...
(function (Hsbc) {
	...
	Hsbc.FormKnowledgeArticleViews = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormKnowledgeArticleViewsMainInteractionCentric = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
