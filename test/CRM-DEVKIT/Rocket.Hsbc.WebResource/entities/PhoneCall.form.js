...
(function (Hsbc) {
	...
	Hsbc.FormPhoneCall = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormPhoneCallforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Hsbc.FormPhonecallquickcreateform = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
