...
declare namespace Hsbc {
	namespace FormContract {
		...
		interface tab_general_Sections {
			...
			contracttype: DevKit.Form.Controls.ControlSection;
	...
	class FormContract extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form Contract
		...
		*/
		...
		Body: Hsbc.FormContract.Body;
		/** The Header section of form Contract */
		Header: Hsbc.FormContract.Header;
	}
	class ContractApi {
		/**
...
//{'JsForm':['Contract'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}