...
declare namespace Hsbc {
	namespace FormSalesOrderDetailInformation {
		interface tab_general_Sections {
			salesorderdetailinformation: DevKit.Form.Controls.ControlSection;
	...
	class FormSalesOrderDetailInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form SalesOrderDetailInformation
		...
		*/
		...
		/** The Body section of form SalesOrderDetailInformation */
		Body: Hsbc.FormSalesOrderDetailInformation.Body;
	}
	...
	class FormSalesOrderDetail extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form SalesOrderDetail
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		Body: Hsbc.FormSalesOrderDetail.Body;
	}
	class SalesOrderDetailApi {
		/**
		* PL.DynamicsCrm.DevKit SalesOrderDetailApi
...
//{'JsForm':['Information','SalesOrderDetail'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}