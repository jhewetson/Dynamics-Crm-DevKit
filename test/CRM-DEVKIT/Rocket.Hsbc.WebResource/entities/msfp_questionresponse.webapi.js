...
(function (Hsbc) {
	'use strict';
	Hsbc.msfp_questionresponseApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msfp_questionresponse) {
			var a = msfp_questionresponse[field].a;
			var b = msfp_questionresponse[field].b;
			var c = msfp_questionresponse[field].c;
			var d = msfp_questionresponse[field].d;
			var g = msfp_questionresponse[field].g;
			var r = msfp_questionresponse[field].r;
			msfp_questionresponse[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msfp_questionresponse.OptionSet = optionSet;
		msfp_questionresponse.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msfp_questionresponse.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
