...
(function (Hsbc) {
	'use strict';
	Hsbc.msdyn_flowcardtypeApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in msdyn_flowcardtype) {
			var a = msdyn_flowcardtype[field].a;
			var b = msdyn_flowcardtype[field].b;
			var c = msdyn_flowcardtype[field].c;
			var d = msdyn_flowcardtype[field].d;
			var g = msdyn_flowcardtype[field].g;
			var r = msdyn_flowcardtype[field].r;
			msdyn_flowcardtype[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		msdyn_flowcardtype.OptionSet = optionSet;
		msdyn_flowcardtype.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		msdyn_flowcardtype.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
