...
(function (Hsbc) {
	...
	Hsbc.FormSocialActivity = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormSocialActivityforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
