...
(function (Hsbc) {
	...
	Hsbc.FormSocialProfile = function(executionContext, defaultWebResourceName) {
	...
	Hsbc.FormSocialProfileforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
