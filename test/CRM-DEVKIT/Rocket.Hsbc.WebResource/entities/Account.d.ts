...
declare namespace Hsbc {
	namespace FormAccount {
		...
		interface Body {
			...
			accountopportunitiesgrid: DevKit.Form.Controls.ControlGrid;
			accountcasessgrid: DevKit.Form.Controls.ControlGrid;
	...
	class FormAccount extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Hsbc.FormAccount.Body;
		/** The Header section of form Account */
		Header: Hsbc.FormAccount.Header;
		/** The Navigation of form Account */
		Navigation: Hsbc.FormAccount.Navigation;
	}
	namespace FormAccountforInteractiveexperience {
		interface Header {
			/** Type the number of employees that work at the account for use in marketing segmentation and demographic analysis. */
			NumberOfEmployees: DevKit.Form.Controls.ControlInteger;
			/** Enter the user or team who is assigned to manage the record. This field is updated every time the record is assigned to a different user. */
	...
	class FormAccountforInteractiveexperience extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form AccountforInteractiveexperience
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form AccountforInteractiveexperience */
		Body: Hsbc.FormAccountforInteractiveexperience.Body;
		/** The Header section of form AccountforInteractiveexperience */
		Header: Hsbc.FormAccountforInteractiveexperience.Header;
		/** The Navigation of form AccountforInteractiveexperience */
		Navigation: Hsbc.FormAccountforInteractiveexperience.Navigation;
	}
	namespace FormAccountAIforSales {
		interface Header {
			/** Type the number of employees that work at the account for use in marketing segmentation and demographic analysis. */
			NumberOfEmployees: DevKit.Form.Controls.ControlInteger;
			/** Enter the user or team who is assigned to manage the record. This field is updated every time the record is assigned to a different user. */
	...
	class FormAccountAIforSales extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form AccountAIforSales
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form AccountAIforSales */
		Body: Hsbc.FormAccountAIforSales.Body;
		/** The Header section of form AccountAIforSales */
		Header: Hsbc.FormAccountAIforSales.Header;
		/** The Navigation of form AccountAIforSales */
		Navigation: Hsbc.FormAccountAIforSales.Navigation;
	}
	namespace FormAccountQuickCreate {
	...
	class FormAccountQuickCreate extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form AccountQuickCreate
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form AccountQuickCreate */
		Body: Hsbc.FormAccountQuickCreate.Body;
	}
	class AccountApi {
		/**
...
//{'JsForm':['Account','Account for Interactive experience','Account Quick Create','AI for Sales'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}