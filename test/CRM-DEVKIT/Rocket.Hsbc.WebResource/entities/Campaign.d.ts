...
declare namespace Hsbc {
	namespace FormCampaign {
		...
		interface tab_SUMMARY_Sections {
			...
			CAMPAIGNACTIVITIES: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormCampaign extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form Campaign
		...
		*/
		...
		Body: Hsbc.FormCampaign.Body;
		/** The Header section of form Campaign */
		Header: Hsbc.FormCampaign.Header;
	}
	class CampaignApi {
		/**
		* PL.DynamicsCrm.DevKit CampaignApi
