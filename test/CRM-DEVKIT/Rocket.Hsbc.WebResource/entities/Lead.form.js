...
(function (Hsbc) {
	...
	Hsbc.FormAIforSales = function(executionContext, defaultWebResourceName) {
		...
		devKit.LoadFields(formContext, _LeadtoOpportunitySalesProcess, "header_process_");
	...
	Hsbc.FormLead = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Hsbc.FormLeadQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
