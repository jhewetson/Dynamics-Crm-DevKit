...
declare namespace Hsbc {
	namespace FormContactAIforSales {
		interface Header {
		...
		interface tab_DETAILS_TAB_Sections {
			...
			marketinginformation: DevKit.Form.Controls.ControlSection;
	...
	class FormContactAIforSales extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form ContactAIforSales
		...
		*/
		...
		/** The Body section of form ContactAIforSales */
		Body: Hsbc.FormContactAIforSales.Body;
		/** The Header section of form ContactAIforSales */
		Header: Hsbc.FormContactAIforSales.Header;
		/** The Navigation of form ContactAIforSales */
		Navigation: Hsbc.FormContactAIforSales.Navigation;
	}
	...
	class FormContact extends DevKit.Form.IForm {
		...
		*/
		...
		Body: Hsbc.FormContact.Body;
		/** The Header section of form Contact */
		Header: Hsbc.FormContact.Header;
		/** The Navigation of form Contact */
		Navigation: Hsbc.FormContact.Navigation;
	}
	namespace FormContactforInteractiveexperience {
		interface Header {
			/** Type the primary email address for the contact. */
			EMailAddress1: DevKit.Form.Controls.ControlString;
			/** Type the job title of the contact to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns. */
	...
	class FormContactforInteractiveexperience extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form ContactforInteractiveexperience
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form ContactforInteractiveexperience */
		Body: Hsbc.FormContactforInteractiveexperience.Body;
		/** The Header section of form ContactforInteractiveexperience */
		Header: Hsbc.FormContactforInteractiveexperience.Header;
		/** The Navigation of form ContactforInteractiveexperience */
		Navigation: Hsbc.FormContactforInteractiveexperience.Navigation;
	}
	namespace FormContactQuickCreate {
	...
	class FormContactQuickCreate extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form ContactQuickCreate
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form ContactQuickCreate */
		Body: Hsbc.FormContactQuickCreate.Body;
	}
	class ContactApi {
		/**
...
//{'JsForm':['AI for Sales','Contact','Contact for Interactive experience','Contact Quick Create'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}