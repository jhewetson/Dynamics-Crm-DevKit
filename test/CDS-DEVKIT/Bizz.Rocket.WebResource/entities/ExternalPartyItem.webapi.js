...
(function (Rocket) {
	'use strict';
	Rocket.ExternalPartyItemApi = function (e) {
		var EMPTY_STRING = '';
		...
		var externalpartyitem = {
			...
			OwningBusinessUnit: { b: 'owningbusinessunit', a: '_owningbusinessunit_value', c: '', d: '' },
			...
			RegardingObjectIdDsc: { a: 'regardingobjectiddsc' },
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in externalpartyitem) {
			var a = externalpartyitem[field].a;
			var b = externalpartyitem[field].b;
			var c = externalpartyitem[field].c;
			var d = externalpartyitem[field].d;
			var g = externalpartyitem[field].g;
			var r = externalpartyitem[field].r;
			externalpartyitem[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		externalpartyitem.OptionSet = optionSet;
		externalpartyitem.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		externalpartyitem.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
