...
(function (Rocket) {
	'use strict';
	Rocket.SdkMessageApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in sdkmessage) {
			var a = sdkmessage[field].a;
			var b = sdkmessage[field].b;
			var c = sdkmessage[field].c;
			var d = sdkmessage[field].d;
			var g = sdkmessage[field].g;
			var r = sdkmessage[field].r;
			sdkmessage[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		sdkmessage.Entity = u;
		...
		sdkmessage.OptionSet = optionSet;
		sdkmessage.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		sdkmessage.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
