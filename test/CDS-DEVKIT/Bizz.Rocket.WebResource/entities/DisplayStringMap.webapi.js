...
(function (Rocket) {
	'use strict';
	Rocket.DisplayStringMapApi = function (e) {
		var EMPTY_STRING = '';
		...
		var displaystringmap = {
			...
			DisplayStringMapIdUnique: { a: 'displaystringmapidunique', r: true },
		...
		displaystringmap.OptionSet = optionSet;
