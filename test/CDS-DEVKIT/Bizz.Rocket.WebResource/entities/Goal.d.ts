...
declare namespace Rocket {
	...
	class FormGoalInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form GoalInformation
		...
		*/
		...
		/** The Body section of form GoalInformation */
		Body: Rocket.FormGoalInformation.Body;
		/** The Footer section of form GoalInformation */
		Footer: Rocket.FormGoalInformation.Footer;
	}
	class GoalApi {
		/**
...
//{'JsForm':['Goal Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}