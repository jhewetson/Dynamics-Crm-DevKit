...
(function (Rocket) {
	...
	Rocket.FormKnowledgeArticle = function(executionContext, defaultWebResourceName) {
		...
		devKit.LoadFields(formContext, _NewProcess, "header_process_");
		process.NewProcess = _NewProcess;
		var _TranslationProcess = {
			ExpirationDate: {},
			LanguageLocaleId: {}
		}
		devKit.LoadFields(formContext, _TranslationProcess, "header_process_");
		process.TranslationProcess = _TranslationProcess;
		var _ExpiredProcess = {
			ExpirationDate: {},
			ExpirationDate_1: {},
		...
		devKit.LoadFields(formContext, _ExpiredProcess, "header_process_");
		process.ExpiredProcess = _ExpiredProcess;
	...
	Rocket.FormKnowledgeArticleforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Rocket.FormKnowledgeArticleQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
