...
declare namespace Rocket {
	namespace FormMailboxInformation {
	...
	class FormMailboxInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form MailboxInformation
		...
		*/
		...
		/** The Body section of form MailboxInformation */
		Body: Rocket.FormMailboxInformation.Body;
		/** The Footer section of form MailboxInformation */
		Footer: Rocket.FormMailboxInformation.Footer;
	}
	class MailboxApi {
		/**
		* PL.DynamicsCrm.DevKit MailboxApi
...
//{'JsForm':['Mailbox Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}