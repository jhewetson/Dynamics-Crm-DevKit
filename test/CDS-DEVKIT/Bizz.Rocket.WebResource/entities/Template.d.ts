...
declare namespace Rocket {
	namespace FormTemplateInformation {
		interface tab_general_Sections {
			emailtemplateinformation: DevKit.Form.Controls.ControlSection;
		}
	...
	class FormTemplateInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form TemplateInformation
		...
		*/
		...
		/** The Body section of form TemplateInformation */
		Body: Rocket.FormTemplateInformation.Body;
	}
	class TemplateApi {
		/**
		* PL.DynamicsCrm.DevKit TemplateApi
