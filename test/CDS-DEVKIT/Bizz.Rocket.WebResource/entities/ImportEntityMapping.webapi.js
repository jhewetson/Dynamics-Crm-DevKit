...
(function (Rocket) {
	'use strict';
	Rocket.ImportEntityMappingApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in importentitymapping) {
			var a = importentitymapping[field].a;
			var b = importentitymapping[field].b;
			var c = importentitymapping[field].c;
			var d = importentitymapping[field].d;
			var g = importentitymapping[field].g;
			var r = importentitymapping[field].r;
			importentitymapping[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		importentitymapping.OptionSet = optionSet;
		importentitymapping.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		importentitymapping.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
