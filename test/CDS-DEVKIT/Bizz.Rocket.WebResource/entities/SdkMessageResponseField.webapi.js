...
(function (Rocket) {
	'use strict';
	Rocket.SdkMessageResponseFieldApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in sdkmessageresponsefield) {
			var a = sdkmessageresponsefield[field].a;
			var b = sdkmessageresponsefield[field].b;
			var c = sdkmessageresponsefield[field].c;
			var d = sdkmessageresponsefield[field].d;
			var g = sdkmessageresponsefield[field].g;
			var r = sdkmessageresponsefield[field].r;
			sdkmessageresponsefield[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		sdkmessageresponsefield.OptionSet = optionSet;
		sdkmessageresponsefield.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		sdkmessageresponsefield.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
