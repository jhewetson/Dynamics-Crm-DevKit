...
(function (Rocket) {
	'use strict';
	Rocket.ReportVisibilityApi = function (e) {
		var EMPTY_STRING = '';
		...
		var reportvisibility = {
			...
			ReportVisibilityId: { a: 'reportvisibilityid' },
			ReportVisibilityIdUnique: { a: 'reportvisibilityidunique', r: true },
			SolutionId: { a: 'solutionid', r: true },
			SupportingSolutionId: { a: 'supportingsolutionid', r: true },
			VersionNumber: { a: 'versionnumber', r: true },
			VisibilityCode: { a: 'visibilitycode' }
		};
		if (e === undefined) e = {};
		var u = {};
		...
		reportvisibility.OptionSet = optionSet;
