...
(function (Rocket) {
	'use strict';
	Rocket.AttributeMapApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in attributemap) {
			var a = attributemap[field].a;
			var b = attributemap[field].b;
			var c = attributemap[field].c;
			var d = attributemap[field].d;
			var g = attributemap[field].g;
			var r = attributemap[field].r;
			attributemap[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		attributemap.OptionSet = optionSet;
		attributemap.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		attributemap.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
