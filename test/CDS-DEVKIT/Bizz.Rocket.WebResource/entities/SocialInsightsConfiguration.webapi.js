...
(function (Rocket) {
	'use strict';
	Rocket.SocialInsightsConfigurationApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in socialinsightsconfiguration) {
			var a = socialinsightsconfiguration[field].a;
			var b = socialinsightsconfiguration[field].b;
			var c = socialinsightsconfiguration[field].c;
			var d = socialinsightsconfiguration[field].d;
			var g = socialinsightsconfiguration[field].g;
			var r = socialinsightsconfiguration[field].r;
			socialinsightsconfiguration[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		socialinsightsconfiguration.OptionSet = optionSet;
		socialinsightsconfiguration.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		socialinsightsconfiguration.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
