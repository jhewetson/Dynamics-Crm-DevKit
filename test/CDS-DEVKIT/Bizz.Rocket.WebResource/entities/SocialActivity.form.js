...
(function (Rocket) {
	...
	Rocket.FormSocialActivity = function(executionContext, defaultWebResourceName) {
	...
	Rocket.FormSocialActivityforInteractiveexperience = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
