...
declare namespace Rocket {
	namespace FormRecommendedDocumentInformation {
		interface Tabs {
		}
		interface Body {
	...
	class FormRecommendedDocumentInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form RecommendedDocumentInformation
		...
		*/
		...
		/** The Body section of form RecommendedDocumentInformation */
		Body: Rocket.FormRecommendedDocumentInformation.Body;
	}
