...
(function (Rocket) {
	'use strict';
	Rocket.SdkMessageProcessingStepImageApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in sdkmessageprocessingstepimage) {
			var a = sdkmessageprocessingstepimage[field].a;
			var b = sdkmessageprocessingstepimage[field].b;
			var c = sdkmessageprocessingstepimage[field].c;
			var d = sdkmessageprocessingstepimage[field].d;
			var g = sdkmessageprocessingstepimage[field].g;
			var r = sdkmessageprocessingstepimage[field].r;
			sdkmessageprocessingstepimage[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		sdkmessageprocessingstepimage.OptionSet = optionSet;
		sdkmessageprocessingstepimage.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		sdkmessageprocessingstepimage.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
