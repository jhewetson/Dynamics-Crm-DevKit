...
declare namespace Rocket {
	...
	class FormFax extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form Fax
		...
		*/
		...
		Body: Rocket.FormFax.Body;
		/** The Header section of form Fax */
		Header: Rocket.FormFax.Header;
	}
	class FaxApi {
		/**
		* PL.DynamicsCrm.DevKit FaxApi
...
//{'JsForm':['Fax'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}