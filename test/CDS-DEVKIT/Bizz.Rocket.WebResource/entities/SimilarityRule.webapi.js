...
(function (Rocket) {
	'use strict';
	Rocket.SimilarityRuleApi = function (e) {
		var EMPTY_STRING = '';
		...
		var similarityrule = {
			ActiveRuleFetchXML: { a: 'activerulefetchxml' },
			...
			RuleConditionXml: { a: 'ruleconditionxml' },
			SimilarityRuleId: { a: 'similarityruleid' },
			SimilarityRuleIdUnique: { a: 'similarityruleidunique', r: true },
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in similarityrule) {
			var a = similarityrule[field].a;
			var b = similarityrule[field].b;
			var c = similarityrule[field].c;
			var d = similarityrule[field].d;
			var g = similarityrule[field].g;
			var r = similarityrule[field].r;
			similarityrule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		similarityrule.Entity = u;
		similarityrule.EntityName = 'similarityrule';
		similarityrule.EntityCollectionName = 'similarityrules';
		similarityrule['@odata.etag'] = e['@odata.etag'];
		var optionSet = {
			RollupState: {
				NotCalculated: 0,
				Calculated: 1,
		...
		similarityrule.OptionSet = optionSet;
		similarityrule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		similarityrule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
