...
(function (Rocket) {
	...
	Rocket.FormKnowledgeArticleViews = function(executionContext, defaultWebResourceName) {
	...
	Rocket.FormKnowledgeArticleViewsMainInteractionCentric = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
