...
(function (Rocket) {
	'use strict';
	Rocket.SocialProfileApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in socialprofile) {
			var a = socialprofile[field].a;
			var b = socialprofile[field].b;
			var c = socialprofile[field].c;
			var d = socialprofile[field].d;
			var g = socialprofile[field].g;
			var r = socialprofile[field].r;
			socialprofile[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		socialprofile.OptionSet = optionSet;
		socialprofile.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		socialprofile.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
