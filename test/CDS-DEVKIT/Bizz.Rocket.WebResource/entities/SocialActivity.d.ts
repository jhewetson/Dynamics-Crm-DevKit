...
declare namespace Rocket {
	...
	class FormSocialActivity extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form SocialActivity
		...
		*/
		...
		/** The Body section of form SocialActivity */
		Body: Rocket.FormSocialActivity.Body;
		/** The Header section of form SocialActivity */
		Header: Rocket.FormSocialActivity.Header;
	}
	namespace FormSocialActivityforInteractiveexperience {
		interface Header {
			/** Shows how contact about the social activity originated, such as from Twitter or Facebook. This field is read-only. */
			Community: DevKit.Form.Controls.ControlOptionSet;
			/** Shows the priority so that preferred customers or critical issues are handled quickly. */
	...
	class FormSocialActivityforInteractiveexperience extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form SocialActivityforInteractiveexperience
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form SocialActivityforInteractiveexperience */
		Body: Rocket.FormSocialActivityforInteractiveexperience.Body;
		/** The Header section of form SocialActivityforInteractiveexperience */
		Header: Rocket.FormSocialActivityforInteractiveexperience.Header;
	}
