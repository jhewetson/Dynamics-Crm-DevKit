...
(function (Rocket) {
	...
	Rocket.SolutionApi = function (e) {
		...
		var solution = {
			...
			PublisherIdOptionValuePrefix: { a: 'publisheridoptionvalueprefix', r: true },
			PublisherIdPrefix: { a: 'publisheridprefix', r: true },
