...
(function (Rocket) {
	'use strict';
	Rocket.CalendarRuleApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in calendarrule) {
			var a = calendarrule[field].a;
			var b = calendarrule[field].b;
			var c = calendarrule[field].c;
			var d = calendarrule[field].d;
			var g = calendarrule[field].g;
			var r = calendarrule[field].r;
			calendarrule[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		calendarrule.OptionSet = optionSet;
		calendarrule.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		calendarrule.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
