...
(function (Rocket) {
	...
	Rocket.FormInformation = function(executionContext, defaultWebResourceName) {
		...
		var tab = {
			{67e8b341-a89a-4207-9bcc-4c1f9cc8b89d}: {
				Section: {
					{89397326-037F-4A43-B362-6B9B04E7917B}: {},
					{29B6CE18-08E1-4B87-B532-B18A6987BBB2}: {}
				}
			},
			{3D17A623-BFEB-49F9-83C4-B5A02B96CAC0}: {
				Section: {
					{0CBFC71F-6EFF-4583-9B38-7A9AE69C3AE1}: {}
				}
			}
		};
