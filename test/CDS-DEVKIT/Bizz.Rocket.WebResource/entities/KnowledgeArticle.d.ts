...
declare namespace Rocket {
	namespace FormKnowledgeArticle {
		...
		interface tab_general_Sections {
			KnowledgeInformation: DevKit.Form.Controls.ControlSection;
			Content: DevKit.Form.Controls.ControlSection;
		}
		interface tab_summary_Sections {
			PortalSettings: DevKit.Form.Controls.ControlSection;
			PublishSettings: DevKit.Form.Controls.ControlSection;
		...
		interface ProcessTranslationProcess {
			/** Enter an expiration date for the article. Leave this field blank for no expiration date. */
			ExpirationDate: DevKit.Form.Controls.ControlDateTime;
			/** Select the language that the article's content is in. */
			LanguageLocaleId: DevKit.Form.Controls.ControlLookup;
		}
		interface ProcessExpiredProcess {
			/** Enter an expiration date for the article. Leave this field blank for no expiration date. */
			ExpirationDate: DevKit.Form.Controls.ControlDateTime;
			/** Enter an expiration date for the article. Leave this field blank for no expiration date. */
		...
		interface Process extends DevKit.Form.Controls.IControlProcess {
			NewProcess: ProcessNewProcess;
			TranslationProcess: ProcessTranslationProcess;
			ExpiredProcess: ProcessExpiredProcess;
		}
	}
	class FormKnowledgeArticle extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form KnowledgeArticle
		...
		*/
		...
		/** The Body section of form KnowledgeArticle */
		Body: Rocket.FormKnowledgeArticle.Body;
		/** The Footer section of form KnowledgeArticle */
		Footer: Rocket.FormKnowledgeArticle.Footer;
		/** The Header section of form KnowledgeArticle */
		Header: Rocket.FormKnowledgeArticle.Header;
		/** The Process of form KnowledgeArticle */
		Process: Rocket.FormKnowledgeArticle.Process;
	}
	namespace FormKnowledgeArticleforInteractiveexperience {
		interface Header {
			/** Select the language that the article's content is in. */
			LanguageLocaleId: DevKit.Form.Controls.ControlLookup;
			/** Select the article's status. */
	...
	class FormKnowledgeArticleforInteractiveexperience extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form KnowledgeArticleforInteractiveexperience
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form KnowledgeArticleforInteractiveexperience */
		Body: Rocket.FormKnowledgeArticleforInteractiveexperience.Body;
		/** The Footer section of form KnowledgeArticleforInteractiveexperience */
		Footer: Rocket.FormKnowledgeArticleforInteractiveexperience.Footer;
		/** The Header section of form KnowledgeArticleforInteractiveexperience */
		Header: Rocket.FormKnowledgeArticleforInteractiveexperience.Header;
		/** The Process of form KnowledgeArticleforInteractiveexperience */
		Process: Rocket.FormKnowledgeArticleforInteractiveexperience.Process;
	}
	namespace FormKnowledgeArticleQuickCreate {
		interface tab_newKnowledgeArticle_Sections {
			quickKnowledgeArticle: DevKit.Form.Controls.ControlSection;
			quickKnowledgecontent: DevKit.Form.Controls.ControlSection;
			quickKnowledgeowner: DevKit.Form.Controls.ControlSection;
		}
		interface tab_newKnowledgeArticle extends DevKit.Form.Controls.IControlTab {
	...
	class FormKnowledgeArticleQuickCreate extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form KnowledgeArticleQuickCreate
		* @param executionContext the execution context
		* @param defaultWebResourceName default resource name. E.g.: "devkit_/resources/Resource"
		*/
		constructor(executionContext: any, defaultWebResourceName?: string);
		...
		/** Provides properties and methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement */
		WebApi: DevKit.Form.WebApi;
		/** The Body section of form KnowledgeArticleQuickCreate */
		Body: Rocket.FormKnowledgeArticleQuickCreate.Body;
	}
	class KnowledgeArticleApi {
		/**
		* PL.DynamicsCrm.DevKit KnowledgeArticleApi
