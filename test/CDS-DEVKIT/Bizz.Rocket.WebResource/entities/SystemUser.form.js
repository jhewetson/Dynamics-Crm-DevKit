...
(function (Rocket) {
	...
	Rocket.FormApplicationUser = function(executionContext, defaultWebResourceName) {
	...
	Rocket.FormUserformBusiness = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
