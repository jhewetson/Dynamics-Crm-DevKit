...
(function (Rocket) {
	'use strict';
	Rocket.AnnualFiscalCalendarApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in annualfiscalcalendar) {
			var a = annualfiscalcalendar[field].a;
			var b = annualfiscalcalendar[field].b;
			var c = annualfiscalcalendar[field].c;
			var d = annualfiscalcalendar[field].d;
			var g = annualfiscalcalendar[field].g;
			var r = annualfiscalcalendar[field].r;
			annualfiscalcalendar[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		annualfiscalcalendar.OptionSet = optionSet;
		annualfiscalcalendar.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		annualfiscalcalendar.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
