...
(function (Rocket) {
	'use strict';
	Rocket.SdkMessageRequestFieldApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in sdkmessagerequestfield) {
			var a = sdkmessagerequestfield[field].a;
			var b = sdkmessagerequestfield[field].b;
			var c = sdkmessagerequestfield[field].c;
			var d = sdkmessagerequestfield[field].d;
			var g = sdkmessagerequestfield[field].g;
			var r = sdkmessagerequestfield[field].r;
			sdkmessagerequestfield[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		sdkmessagerequestfield.OptionSet = optionSet;
		sdkmessagerequestfield.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		sdkmessagerequestfield.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
