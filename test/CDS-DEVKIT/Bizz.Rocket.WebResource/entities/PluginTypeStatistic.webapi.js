...
(function (Rocket) {
	'use strict';
	Rocket.PluginTypeStatisticApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in plugintypestatistic) {
			var a = plugintypestatistic[field].a;
			var b = plugintypestatistic[field].b;
			var c = plugintypestatistic[field].c;
			var d = plugintypestatistic[field].d;
			var g = plugintypestatistic[field].g;
			var r = plugintypestatistic[field].r;
			plugintypestatistic[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		plugintypestatistic.OptionSet = optionSet;
		plugintypestatistic.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		plugintypestatistic.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
