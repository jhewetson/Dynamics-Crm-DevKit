...
(function (Rocket) {
	'use strict';
	Rocket.ImportLogApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in importlog) {
			var a = importlog[field].a;
			var b = importlog[field].b;
			var c = importlog[field].c;
			var d = importlog[field].d;
			var g = importlog[field].g;
			var r = importlog[field].r;
			importlog[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		importlog.Entity = u;
		...
		importlog.OptionSet = optionSet;
		importlog.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		importlog.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
