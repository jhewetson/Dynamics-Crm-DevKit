...
(function (Rocket) {
	'use strict';
	Rocket.RecommendedDocumentApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in recommendeddocument) {
			var a = recommendeddocument[field].a;
			var b = recommendeddocument[field].b;
			var c = recommendeddocument[field].c;
			var d = recommendeddocument[field].d;
			var g = recommendeddocument[field].g;
			var r = recommendeddocument[field].r;
			recommendeddocument[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		recommendeddocument.OptionSet = optionSet;
		recommendeddocument.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		recommendeddocument.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
