...
(function (Rocket) {
	'use strict';
	Rocket.SubscriptionApi = function (e) {
		var EMPTY_STRING = '';
		...
		for (var field in subscription) {
			var a = subscription[field].a;
			var b = subscription[field].b;
			var c = subscription[field].c;
			var d = subscription[field].d;
			var g = subscription[field].g;
			var r = subscription[field].r;
			subscription[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		subscription.OptionSet = optionSet;
		subscription.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		subscription.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
