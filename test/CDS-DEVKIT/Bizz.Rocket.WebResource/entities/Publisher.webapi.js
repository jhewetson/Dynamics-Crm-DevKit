...
(function (Rocket) {
	'use strict';
	Rocket.PublisherApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in publisher) {
			var a = publisher[field].a;
			var b = publisher[field].b;
			var c = publisher[field].c;
			var d = publisher[field].d;
			var g = publisher[field].g;
			var r = publisher[field].r;
			publisher[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		publisher.Entity = u;
		...
		publisher.OptionSet = optionSet;
		publisher.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		publisher.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
