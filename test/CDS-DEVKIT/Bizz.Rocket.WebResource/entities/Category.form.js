...
(function (Rocket) {
	...
	Rocket.FormCategory = function(executionContext, defaultWebResourceName) {
	...
	Rocket.FormCategoryMainInteractive = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined) {
			if (executionContext.getFormContext === undefined) {
				formContext = executionContext;
	...
	Rocket.FormCategoryQuickCreate = function(executionContext, defaultWebResourceName) {
		var formContext = null;
		if (executionContext !== undefined)
		{
			if (executionContext.getFormContext === undefined) {
