...
(function (Rocket) {
	'use strict';
	Rocket.KnowledgeSearchModelApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in knowledgesearchmodel) {
			var a = knowledgesearchmodel[field].a;
			var b = knowledgesearchmodel[field].b;
			var c = knowledgesearchmodel[field].c;
			var d = knowledgesearchmodel[field].d;
			var g = knowledgesearchmodel[field].g;
			var r = knowledgesearchmodel[field].r;
			knowledgesearchmodel[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		knowledgesearchmodel.OptionSet = optionSet;
		knowledgesearchmodel.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		knowledgesearchmodel.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
