...
(function (Rocket) {
	...
	Rocket.TeamApi = function (e) {
		...
		var team = {
			...
			RegardingObjectId: { b: 'regardingobjectid', a: '_regardingobjectid_value', c: 'knowledgearticles', d: 'knowledgearticle' },
			StageId: { a: 'stageid' },
