...
declare namespace Rocket {
	namespace FormExternalPartyItemInformation {
		interface Header {
	...
	class FormExternalPartyItemInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form ExternalPartyItemInformation
		...
		*/
		...
		/** The Body section of form ExternalPartyItemInformation */
		Body: Rocket.FormExternalPartyItemInformation.Body;
		/** The Header section of form ExternalPartyItemInformation */
		Header: Rocket.FormExternalPartyItemInformation.Header;
	}
...
//{'JsForm':['ExternalPartyItem Information'],'JsWebApi':true,'IsDebugForm':true,'IsDebugWebApi':true}