...
declare namespace Rocket {
	namespace FormPluginTraceLogInformation {
		interface Header {
	...
	class FormPluginTraceLogInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form PluginTraceLogInformation
		...
		*/
		...
		/** The Body section of form PluginTraceLogInformation */
		Body: Rocket.FormPluginTraceLogInformation.Body;
		/** The Header section of form PluginTraceLogInformation */
		Header: Rocket.FormPluginTraceLogInformation.Header;
	}
