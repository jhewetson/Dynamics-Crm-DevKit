...
(function (Rocket) {
	...
	Rocket.FormInformation = function(executionContext, defaultWebResourceName) {
		...
		var tab = {
			...
			{349a439d-6ed5-bae8-7c7d-3721869367ca}: {
				Section: {
					{3a5c2dc2-2ee7-848c-83eb-a2b1e4d1c703}: {}
				}
			},
			: {
				Section: {
					{48707907-e91e-1590-1cd1-a9ddb71476d7}: {},
					{adadc153-6be6-448b-7b31-64c39637829b}: {},
					{a7c72450-609e-c738-4557-781b2088c473}: {}
				}
			},
			: {
				Section: {
					{89ae1e95-1ccc-8646-eece-5de9e57b9743}: {}
				}
			},
			: {
				Section: {
					{1d7eac24-348a-75b1-8a7b-c1dbbc2d7930}: {},
					{7c93d1dd-bcb6-8994-06ba-b913cab6bdb4}: {},
					{86aa59b3-d012-bd70-488b-6d2767ea858d}: {}
				}
			},
			: {
				Section: {
					{16152234-8617-bee9-5eeb-069b4472173d}: {},
					{649d4e80-5014-8c90-2abe-c39b137dc761}: {},
					{009e75c7-d9c6-e460-98b7-4278be07024b}: {}
				}
			},
			notes: {
				Section: {
			...
			{242FCD83-2A50-478E-922A-F4641920DDE0}: {
				Section: {
					{8ECDE6CB-085B-46D1-97A9-E357C5799076}: {}
				}
			}
		};
