...
(function (Rocket) {
	...
	Rocket.PostRoleApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in postrole) {
			var a = postrole[field].a;
			var b = postrole[field].b;
			var c = postrole[field].c;
			var d = postrole[field].d;
			var g = postrole[field].g;
			var r = postrole[field].r;
			postrole[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		postrole.Entity = u;
		...
		postrole.OptionSet = optionSet;
		postrole.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		postrole.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
