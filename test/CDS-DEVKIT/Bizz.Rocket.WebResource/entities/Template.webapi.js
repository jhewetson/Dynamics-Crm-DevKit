...
(function (Rocket) {
	...
	Rocket.TemplateApi = function (e) {
		...
		for (var field in template) {
			var a = template[field].a;
			var b = template[field].b;
			var c = template[field].c;
			var d = template[field].d;
			var g = template[field].g;
			var r = template[field].r;
			template[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		template.Entity = u;
		...
		template.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		template.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
