...
declare namespace Rocket {
	namespace FormRollupFieldInformation {
	...
	class FormRollupFieldInformation extends DevKit.Form.IForm {
		/**
		* PL.DynamicsCrm.DevKit form RollupFieldInformation
		...
		*/
		...
		/** The Body section of form RollupFieldInformation */
		Body: Rocket.FormRollupFieldInformation.Body;
	}
