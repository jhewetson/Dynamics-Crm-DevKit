...
(function (Rocket) {
	'use strict';
	Rocket.TransformationMappingApi = function (e) {
		var EMPTY_STRING = '';
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in transformationmapping) {
			var a = transformationmapping[field].a;
			var b = transformationmapping[field].b;
			var c = transformationmapping[field].c;
			var d = transformationmapping[field].d;
			var g = transformationmapping[field].g;
			var r = transformationmapping[field].r;
			transformationmapping[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		...
		transformationmapping.OptionSet = optionSet;
		transformationmapping.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		transformationmapping.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
