...
(function (Rocket) {
	...
	Rocket.SLAItemApi = function (e) {
		...
		if (e === undefined) e = {};
		var u = {};
		for (var field in slaitem) {
			var a = slaitem[field].a;
			var b = slaitem[field].b;
			var c = slaitem[field].c;
			var d = slaitem[field].d;
			var g = slaitem[field].g;
			var r = slaitem[field].r;
			slaitem[field] = webApiField(e, a, b, c, d, r, u, g);
		}
		slaitem.Entity = u;
		...
		slaitem.OptionSet = optionSet;
		slaitem.getAliasedValue = function (alias, isMultiOptionSet) {
		...
		slaitem.getAliasedFormattedValue = function (alias, isMultiOptionSet) {
